...
def initialize_federates(wiring_diagram: WiringDiagram,
    ...
    for l in wiring_diagram.links:
        ...
        assert l.target_port in target_types, f'{l.target} does not have {l.target_port}'
    ...
    for name, component in components.items():
        ...
        federates.append(Federate(
            directory=name,
            name=name,
            exec=component.execute_function
        ))
...
def generate_runner_config(wiring_diagram: WiringDiagram,
                           component_types: Dict[str, Type[ComponentType]],
                           compatability_checker=bad_compatability_checker):
    federates = initialize_federates(wiring_diagram, component_types, compatability_checker)
