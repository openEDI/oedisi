...
**OEDISI** (Open Energy Data Initiative — System Integration) is an orchestration
...
Drive OEDISI from the Python API and CLI, and scale out with the
...
your first simulation, or see **[how OEDISI works](overview.md)** for the mental model.

:::{seealso} Source repositories
OEDISI spans three repositories:
